...
struct Reviews: Codable {
    ...
    init(id: String, appointmentReference: DocumentReference, comment: String, createdAt: String, doctorReference: DocumentReference, score: Int, type: String, updatedAt: String, patientReference: DocumentReference) {
        self.id = id
